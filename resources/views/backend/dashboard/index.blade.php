            ...
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Incidences Recorded</div>
...
<ul>
    <li>Incidence row number</li>
    <li>Number of states</li>
    <li>Number of states with incidences</li>
